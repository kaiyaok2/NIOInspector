...
public class CollectTestInfoMojoTest {
    ...
    public void setUp() throws Exception {
        ...
        try (FileWriter writer = new FileWriter(logFile)) {
            ...
            writer.write("[INFO] \n");
            writer.write("[WARN] Failing Test: edu.illinois.NIOInspector.plugin.mojo.CollectTestInfoMojoTest#testMethod\n");
            writer.write("[WARN] Failure message: \n");
            writer.write("java.lang.AssertionError: expected:<true> but was:<false>\n");
            writer.write("\tat edu.illinois.NIOInspector.plugin.mojo.CollectTestInfoMojoTest.testMethod(CollectTestInfoMojoTest.java:10)\n");
            writer.write("[WARN] All Failed tests:\n");
            writer.write("[WARN] testMethod(): [engine:junit-jupiter]/[class:edu.illinois.NIOInspector.plugin.mojo.CollectTestInfoMojoTest]/[method:testMethod()]\n");
            writer.write("[INFO] \n");
            writer.write("[INFO] =========================Final Results=========================\n");
            writer.write("[INFO] \n");
            writer.write("[ERROR] Number of Possible NIO Test(s) Found: 1\n");
            writer.write("[ERROR] edu.illinois.NIOInspector.plugin.mojo.CollectTestInfoMojoTest#testMethod (passed in the initial run but failed in 1 out of 1 reruns)\n");
        }
    }
    ...
    public void testGetPossibleNIOTests() throws Exception {
        ...
        assertEquals("edu.illinois.NIOInspector.plugin.mojo.CollectTestInfoMojoTest#testMethod", result.get(0));
    }
    ...
    public void testWriteStackTrace() throws Exception {
        ...
        method.invoke(mojo, "edu.illinois.NIOInspector.plugin.mojo.CollectTestInfoMojoTest#testMethod", tempDir.getAbsolutePath(), logFile);
        method.setAccessible(false);

        File stackTraceFile = new File(tempDir, "edu.illinois.NIOInspector.plugin.mojo.CollectTestInfoMojoTest.testMethod/stacktrace1");
    ...
    public void testExtractStackTrace() throws Exception {
        ...
        method.invoke(mojo, 3, tempDir.getAbsolutePath(), logFile, "edu.illinois.NIOInspector.plugin.mojo.CollectTestInfoMojoTest", 1);
        method.setAccessible(false);

        File stackTraceFile = new File(tempDir, "edu.illinois.NIOInspector.plugin.mojo.CollectTestInfoMojoTest/stacktrace1");
        assertTrue(stackTraceFile.exists());
    }
    ...
    public void testWriteReducedTestFile() throws Exception {
        ...
        method.invoke(mojo, "edu.illinois.NIOInspector.plugin.mojo.CollectTestInfoMojoTest#testMethod", tempDir.getAbsolutePath());
        method.setAccessible(false);
